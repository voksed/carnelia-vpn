...
#ifndef winstore_set_ctx_params_list
static const OSSL_PARAM winstore_set_ctx_params_list[] = {
...
#ifndef winstore_set_ctx_params_st
struct winstore_set_ctx_params_st {
    OSSL_PARAM *propq;
    OSSL_PARAM *sub;
};
#endif

#ifndef winstore_set_ctx_params_decoder
static int winstore_set_ctx_params_decoder
    (const OSSL_PARAM *p, struct winstore_set_ctx_params_st *r)
{
    const char *s;
